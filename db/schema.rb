...
ActiveRecord::Schema[7.0].define(version: 2023_10_20_103435) do
  create_table "attenders", force: :cascade do |t|
    ...
    t.index ["email"], name: "index_attenders_on_email", unique: true
    t.index ["reset_password_token"], name: "index_attenders_on_reset_password_token", unique: true
  end
